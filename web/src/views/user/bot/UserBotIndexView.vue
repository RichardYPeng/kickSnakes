...
export default {
    ...
    setup() {
        ...
        const refresh_bots = () => {
            $.ajax({
                // url: "https://app3882.acapp.acwing.com.cn/api/user/bot/getlist/",
        ...
        const add_bot = () => {
            ...
            $.ajax({
                //url: "https://app3882.acapp.acwing.com.cn/api/user/bot/add/",
        ...
        const update_bot = (bot) => {
            botadd.error_message = "";
            $.ajax({
                // url: "https://app3882.acapp.acwing.com.cn/api/user/bot/update/",
        ...
        const remove_bot = (bot) => {
            $.ajax({
                //url: "https://app3882.acapp.acwing.com.cn/api/user/bot/remove/",
